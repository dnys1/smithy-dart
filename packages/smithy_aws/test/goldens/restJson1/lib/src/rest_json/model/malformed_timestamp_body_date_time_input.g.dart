...
part of rest_json1.rest_json.model.malformed_timestamp_body_date_time_input;
...
class _$MalformedTimestampBodyDateTimeInput
  ...
  _$MalformedTimestampBodyDateTimeInput._({required this.timestamp})
    ...
    BuiltValueNullFieldError.checkNotNull(
        timestamp, 'MalformedTimestampBodyDateTimeInput', 'timestamp');
  }
...
class MalformedTimestampBodyDateTimeInputBuilder
  ...
  @override
  _$MalformedTimestampBodyDateTimeInput build() {
    final _$result = _$v ??
...
class _$MalformedTimestampBodyDateTimeInputPayload
    extends MalformedTimestampBodyDateTimeInputPayload {
  @override
  final DateTime timestamp;

  factory _$MalformedTimestampBodyDateTimeInputPayload(
          [void Function(MalformedTimestampBodyDateTimeInputPayloadBuilder)?
              updates]) =>
      (new MalformedTimestampBodyDateTimeInputPayloadBuilder()..update(updates))
          .build();

  _$MalformedTimestampBodyDateTimeInputPayload._({required this.timestamp})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        timestamp, 'MalformedTimestampBodyDateTimeInputPayload', 'timestamp');
  }

  @override
  MalformedTimestampBodyDateTimeInputPayload rebuild(
          void Function(MalformedTimestampBodyDateTimeInputPayloadBuilder)
              updates) =>
      (toBuilder()..update(updates)).build();

  @override
  MalformedTimestampBodyDateTimeInputPayloadBuilder toBuilder() =>
      new MalformedTimestampBodyDateTimeInputPayloadBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is MalformedTimestampBodyDateTimeInputPayload &&
        timestamp == other.timestamp;
  }
...
class MalformedTimestampBodyDateTimeInputPayloadBuilder
    implements
        Builder<MalformedTimestampBodyDateTimeInputPayload,
            MalformedTimestampBodyDateTimeInputPayloadBuilder> {
  _$MalformedTimestampBodyDateTimeInputPayload? _$v;
  ...
  MalformedTimestampBodyDateTimeInputPayloadBuilder() {
    MalformedTimestampBodyDateTimeInputPayload._init(this);
  }

  MalformedTimestampBodyDateTimeInputPayloadBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _timestamp = $v.timestamp;
      _$v = null;
  ...
  @override
  void replace(MalformedTimestampBodyDateTimeInputPayload other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$MalformedTimestampBodyDateTimeInputPayload;
  }
  ...
  @override
  _$MalformedTimestampBodyDateTimeInputPayload build() {
    final _$result = _$v ??
        new _$MalformedTimestampBodyDateTimeInputPayload._(
            timestamp: BuiltValueNullFieldError.checkNotNull(timestamp,
                'MalformedTimestampBodyDateTimeInputPayload', 'timestamp'));
    replace(_$result);
    return _$result;
  }
}
