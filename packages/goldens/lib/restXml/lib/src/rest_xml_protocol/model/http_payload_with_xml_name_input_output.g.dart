...
class _$HttpPayloadWithXmlNameInputOutput
  ...
  factory _$HttpPayloadWithXmlNameInputOutput(
      ...
      (new HttpPayloadWithXmlNameInputOutputBuilder()..update(updates)).build();
...
class HttpPayloadWithXmlNameInputOutputBuilder
  ...
  @override
  _$HttpPayloadWithXmlNameInputOutput build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'HttpPayloadWithXmlNameInputOutput', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
