...
library rest_xml.rest_xml_protocol.test.constant_and_variable_query_string_operation_test_test;
    ...
    () async {
      await _i2.httpRequestTest(
          ...
          inputSerializers: const [
            _ConstantAndVariableQueryStringInputRestXmlSerializer()
          ]);
    },
  );
  _i1.test(
...
class _ConstantAndVariableQueryStringInputRestXmlSerializer extends _i4
    .StructuredSmithySerializer<_i5.ConstantAndVariableQueryStringInput> {
  const _ConstantAndVariableQueryStringInputRestXmlSerializer()
