...
part of rest_json1.rest_json.model.http_payload_traits_input_output;
...
class _$HttpPayloadTraitsInputOutput extends HttpPayloadTraitsInputOutput {
  ...
  factory _$HttpPayloadTraitsInputOutput(
      ...
      (new HttpPayloadTraitsInputOutputBuilder()..update(updates)).build();
...
class HttpPayloadTraitsInputOutputBuilder
  ...
  @override
  _$HttpPayloadTraitsInputOutput build() {
    final _$result =
