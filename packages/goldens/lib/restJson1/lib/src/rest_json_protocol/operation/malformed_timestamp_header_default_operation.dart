...
library rest_json1.rest_json_protocol.operation.malformed_timestamp_header_default_operation;
...
class MalformedTimestampHeaderDefaultOperation extends _i1.HttpOperation<
    ...
    _i1.Unit,
    _i1.Unit> {
  MalformedTimestampHeaderDefaultOperation({Uri? baseUri, required this.region})
      : _baseUri = baseUri;
