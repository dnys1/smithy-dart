...
part of rest_json1.rest_json_validation_protocol.model.malformed_length_override_input;
...
class _$MalformedLengthOverrideInput extends MalformedLengthOverrideInput {
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('MalformedLengthOverrideInput')
          ..add('blob', blob)
          ..add('list', list)
          ..add('map', map)
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'MalformedLengthOverrideInput', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
