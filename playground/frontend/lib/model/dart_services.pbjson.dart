...
const VersionResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'packageInfo', '3': 10, '4': 3, '5': 11, '6': '.dart_services.api.PackageInfo', '10': 'packageInfo'},
    const {'1': 'error', '3': 99, '4': 1, '5': 11, '6': '.dart_services.api.ErrorMessage', '10': 'error'},
  ],
...
final $typed_data.Uint8List versionResponseDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List packageInfoDescriptor = $convert.base64Decode('CgtQYWNrYWdlSW5mbxISCgRuYW1lGAEgASgJUgRuYW1lEhgKB3ZlcnNpb24YAiABKAlSB3ZlcnNpb24SHAoJc3VwcG9ydGVkGAMgASgIUglzdXBwb3J0ZWQ=');
