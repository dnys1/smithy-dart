    ...
    () async {
      await _i2.httpRequestTest(
          ...
          inputSerializers: const [
            ...
            _NestedPayloadRestXmlSerializer()
          ]);
    },
  );
  _i1.test(
...
class _HttpPayloadWithStructureInputOutputRestXmlSerializer extends _i4
    .StructuredSmithySerializer<_i5.HttpPayloadWithStructureInputOutput> {
  const _HttpPayloadWithStructureInputOutputRestXmlSerializer()
...
class _NestedPayloadRestXmlSerializer
    extends _i4.StructuredSmithySerializer<_i6.NestedPayload> {
  const _NestedPayloadRestXmlSerializer() : super('NestedPayload');
