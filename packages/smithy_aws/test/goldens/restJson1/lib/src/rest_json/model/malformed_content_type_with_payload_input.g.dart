...
part of rest_json1.rest_json.model.malformed_content_type_with_payload_input;
...
class _$MalformedContentTypeWithPayloadInput
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('MalformedContentTypeWithPayloadInput')
          ..add('payload', payload))
        .toString();
  }
}
...
class MalformedContentTypeWithPayloadInputBuilder
  ...
  @override
  _$MalformedContentTypeWithPayloadInput build() {
    final _$result =
