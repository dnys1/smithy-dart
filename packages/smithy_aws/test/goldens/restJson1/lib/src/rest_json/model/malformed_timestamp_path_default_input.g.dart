...
part of rest_json1.rest_json.model.malformed_timestamp_path_default_input;
...
class _$MalformedTimestampPathDefaultInput
  ...
  _$MalformedTimestampPathDefaultInput._({required this.timestamp})
    ...
    BuiltValueNullFieldError.checkNotNull(
        timestamp, 'MalformedTimestampPathDefaultInput', 'timestamp');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('MalformedTimestampPathDefaultInput')
...
class MalformedTimestampPathDefaultInputBuilder
  ...
  @override
  _$MalformedTimestampPathDefaultInput build() {
    final _$result = _$v ??
...
class MalformedTimestampPathDefaultInputPayloadBuilder
  ...
  @override
  _$MalformedTimestampPathDefaultInputPayload build() {
