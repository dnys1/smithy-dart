...
part of rest_json1.rest_json_validation_protocol.model.validation_exception_field;
...
class _$ValidationExceptionField extends ValidationExceptionField {
  ...
  factory _$ValidationExceptionField(
      ...
      (new ValidationExceptionFieldBuilder()..update(updates)).build();

  _$ValidationExceptionField._({required this.message, required this.path})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        message, 'ValidationExceptionField', 'message');
    BuiltValueNullFieldError.checkNotNull(
        path, 'ValidationExceptionField', 'path');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('ValidationExceptionField')
          ..add('message', message)
          ..add('path', path))
        .toString();
  }
...
class ValidationExceptionFieldBuilder
  ...
  @override
  _$ValidationExceptionField build() {
    final _$result = _$v ??
