...
part of rest_json1.rest_json_validation_protocol.model.malformed_range_input;
...
class _$MalformedRangeInput extends MalformedRangeInput {
  ...
  factory _$MalformedRangeInput(
      ...
      (new MalformedRangeInputBuilder()..update(updates)).build();
  ...
  _$MalformedRangeInput._(
      ...
      : super._() {
    BuiltValueNullFieldError.checkNotNull(byte, 'MalformedRangeInput', 'byte');
    BuiltValueNullFieldError.checkNotNull(
        float, 'MalformedRangeInput', 'float');
    BuiltValueNullFieldError.checkNotNull(
        maxByte, 'MalformedRangeInput', 'maxByte');
    BuiltValueNullFieldError.checkNotNull(
        maxFloat, 'MalformedRangeInput', 'maxFloat');
    BuiltValueNullFieldError.checkNotNull(
        minByte, 'MalformedRangeInput', 'minByte');
    BuiltValueNullFieldError.checkNotNull(
        minFloat, 'MalformedRangeInput', 'minFloat');
  }
