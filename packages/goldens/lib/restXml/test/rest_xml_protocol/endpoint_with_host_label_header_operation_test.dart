...
library rest_xml.rest_xml_protocol.test.endpoint_with_host_label_header_operation_test_test;
    ...
    () async {
      await _i2.httpRequestTest(
          ...
          testCase: const _i2.HttpRequestTestCase(
              ...
              forbidQueryParams: [],
              requireQueryParams: []),
          inputSerializers: const [_HostLabelHeaderInputRestXmlSerializer()]);
    },
  );
}
