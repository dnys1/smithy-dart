...
part of rest_json1.rest_json.model.http_payload_with_structure_input_output;
...
class HttpPayloadWithStructureInputOutputBuilder
  ...
  @override
  _$HttpPayloadWithStructureInputOutput build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'HttpPayloadWithStructureInputOutput', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
