...
part of rest_json1.rest_json.model.test_payload_structure_input_output;
...
class _$TestPayloadStructureInputOutput
  ...
  factory _$TestPayloadStructureInputOutput(
      ...
      (new TestPayloadStructureInputOutputBuilder()..update(updates)).build();
...
class TestPayloadStructureInputOutputBuilder
  ...
  @override
  _$TestPayloadStructureInputOutput build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'TestPayloadStructureInputOutput', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
