...
part of rest_json1.rest_json_validation_protocol.model.malformed_length_input;
...
class _$MalformedLengthInput extends MalformedLengthInput {
  ...
  factory _$MalformedLengthInput(
      ...
      (new MalformedLengthInputBuilder()..update(updates)).build();
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'MalformedLengthInput', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
