...
library rest_json1.rest_json.operation.unit_input_and_output_test;
...
void main() {
  _i1.test('RestJsonUnitInputAndOutput (restJson1)', () async {
  ...
  _i1.test('RestJsonUnitInputAndOutputNoOutput (restJson1)', () async {
