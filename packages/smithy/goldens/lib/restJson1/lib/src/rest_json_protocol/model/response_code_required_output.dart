...
library rest_json1.rest_json_protocol.model.response_code_required_output;
...
abstract class ResponseCodeRequiredOutput
  ...
  static const List<_i2.SmithySerializer> serializers = [
    _ResponseCodeRequiredOutputRestJson1Serializer()
  ];
...
class _ResponseCodeRequiredOutputRestJson1Serializer
    extends _i2.StructuredSmithySerializer<ResponseCodeRequiredOutputPayload> {
  const _ResponseCodeRequiredOutputRestJson1Serializer()
