...
class _$MalformedRangeInput extends MalformedRangeInput {
  ...
  _$MalformedRangeInput._(
      ...
      : super._() {
    BuiltValueNullFieldError.checkNotNull(byte, r'MalformedRangeInput', 'byte');
    BuiltValueNullFieldError.checkNotNull(
        float, r'MalformedRangeInput', 'float');
    BuiltValueNullFieldError.checkNotNull(
        maxByte, r'MalformedRangeInput', 'maxByte');
    BuiltValueNullFieldError.checkNotNull(
        maxFloat, r'MalformedRangeInput', 'maxFloat');
    BuiltValueNullFieldError.checkNotNull(
        minByte, r'MalformedRangeInput', 'minByte');
    BuiltValueNullFieldError.checkNotNull(
        minFloat, r'MalformedRangeInput', 'minFloat');
  }
    ...
    final _$result = _$v ??
        new _$MalformedRangeInput._(
            byte: BuiltValueNullFieldError.checkNotNull(
                byte, r'MalformedRangeInput', 'byte'),
