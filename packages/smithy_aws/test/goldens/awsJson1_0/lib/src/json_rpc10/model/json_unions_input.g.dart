...
class _$JsonUnionsInputPayload extends JsonUnionsInputPayload {
  @override
  final _i2.MyUnion? contents;

  factory _$JsonUnionsInputPayload(
          [void Function(JsonUnionsInputPayloadBuilder)? updates]) =>
      (new JsonUnionsInputPayloadBuilder()..update(updates)).build();

  _$JsonUnionsInputPayload._({this.contents}) : super._();

  @override
  JsonUnionsInputPayload rebuild(
          void Function(JsonUnionsInputPayloadBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  JsonUnionsInputPayloadBuilder toBuilder() =>
      new JsonUnionsInputPayloadBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is JsonUnionsInputPayload && contents == other.contents;
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('JsonUnionsInputPayload')
          ..add('contents', contents))
        .toString();
  }
}

class JsonUnionsInputPayloadBuilder
    implements Builder<JsonUnionsInputPayload, JsonUnionsInputPayloadBuilder> {
  _$JsonUnionsInputPayload? _$v;

  _i2.MyUnion? _contents;
  _i2.MyUnion? get contents => _$this._contents;
  set contents(_i2.MyUnion? contents) => _$this._contents = contents;

  JsonUnionsInputPayloadBuilder() {
    JsonUnionsInputPayload._init(this);
  }

  JsonUnionsInputPayloadBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _contents = $v.contents;
      _$v = null;
  ...
  @override
  void replace(JsonUnionsInputPayload other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$JsonUnionsInputPayload;
  }

  @override
  void update(void Function(JsonUnionsInputPayloadBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  _$JsonUnionsInputPayload build() {
    final _$result = _$v ?? new _$JsonUnionsInputPayload._(contents: contents);
    replace(_$result);
    return _$result;
  }
}
