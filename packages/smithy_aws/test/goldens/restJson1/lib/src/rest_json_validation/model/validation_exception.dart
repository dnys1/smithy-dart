...
library rest_json1.rest_json_validation.model.validation_exception;
...
abstract class ValidationException
    with _i1.SmithyException, _i2.AWSEquatable<ValidationException>
  ...
  factory ValidationException.fromResponse(
          ValidationException payload, _i2.AWSStreamedHttpResponse response) =>
      payload;
...
class _ValidationExceptionRestJson1Serializer
    extends _i1.StructuredSmithySerializer<ValidationException> {
