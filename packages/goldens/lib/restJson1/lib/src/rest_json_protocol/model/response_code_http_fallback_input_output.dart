...
library rest_json1.rest_json_protocol.model.response_code_http_fallback_input_output;
...
abstract class ResponseCodeHttpFallbackInputOutput
  ...
  static const List<_i1.SmithySerializer> serializers = [
    _ResponseCodeHttpFallbackInputOutputRestJson1Serializer()
  ];
...
class _ResponseCodeHttpFallbackInputOutputRestJson1Serializer extends _i1
    .StructuredSmithySerializer<ResponseCodeHttpFallbackInputOutput> {
  const _ResponseCodeHttpFallbackInputOutputRestJson1Serializer()
