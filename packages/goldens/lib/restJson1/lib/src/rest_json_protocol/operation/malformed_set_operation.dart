...
library rest_json1.rest_json_protocol.operation.malformed_set_operation;
...
class MalformedSetOperation extends _i1.HttpOperation<_i2.MalformedSetInput,
    _i2.MalformedSetInput, _i1.Unit, _i1.Unit> {
  MalformedSetOperation({required String region, Uri? baseUri})
      : _region = region,
        _baseUri = baseUri;

  @override
  late final List<
      _i1.HttpProtocol<_i2.MalformedSetInput, _i2.MalformedSetInput, _i1.Unit,
          _i1.Unit>> protocols = [
  ...
  @override
  _i7.Future<_i1.Unit> run(_i2.MalformedSetInput input,
