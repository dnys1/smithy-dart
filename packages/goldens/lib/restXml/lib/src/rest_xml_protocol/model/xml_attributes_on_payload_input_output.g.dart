...
class _$XmlAttributesOnPayloadInputOutput
  ...
  factory _$XmlAttributesOnPayloadInputOutput(
      ...
      (new XmlAttributesOnPayloadInputOutputBuilder()..update(updates)).build();
...
class XmlAttributesOnPayloadInputOutputBuilder
  ...
  @override
  _$XmlAttributesOnPayloadInputOutput build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'XmlAttributesOnPayloadInputOutput', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
