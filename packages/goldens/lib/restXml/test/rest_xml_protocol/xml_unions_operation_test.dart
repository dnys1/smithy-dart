...
library rest_xml.rest_xml_protocol.test.xml_unions_operation_test_test;
    ...
    () async {
      await _i2.httpRequestTest(
          ...
          testCase: const _i2.HttpRequestTestCase(
              ...
              forbidQueryParams: [],
              requireQueryParams: []),
          inputSerializers: const [_XmlUnionsInputOutputRestXmlSerializer()]);
    },
  );
  _i1.test(
    ...
    () async {
      await _i2.httpResponseTest(
          ...
          testCase: const _i2.HttpResponseTestCase(
              ...
              appliesTo: null,
              code: 200),
          outputSerializers: const [_XmlUnionsInputOutputRestXmlSerializer()]);
    },
  );
  _i1.test(
...
class _XmlUnionsInputOutputRestXmlSerializer
    extends _i4.StructuredSmithySerializer<_i5.XmlUnionsInputOutput> {
  const _XmlUnionsInputOutputRestXmlSerializer()
      : super('XmlUnionsInputOutput');
