...
part of aws_json1_0.json_rpc10.model.greeting_with_errors_output;
...
class _$GreetingWithErrorsOutput extends GreetingWithErrorsOutput {
  ...
  factory _$GreetingWithErrorsOutput(
      ...
      (new GreetingWithErrorsOutputBuilder()..update(updates)).build();
...
class GreetingWithErrorsOutputBuilder
  ...
  @override
  _$GreetingWithErrorsOutput build() {
    final _$result =
...
class _$GreetingWithErrorsOutputPayload
  ...
  factory _$GreetingWithErrorsOutputPayload(
      ...
      (new GreetingWithErrorsOutputPayloadBuilder()..update(updates)).build();

  _$GreetingWithErrorsOutputPayload._({this.greeting}) : super._();
...
class GreetingWithErrorsOutputPayloadBuilder
  ...
  GreetingWithErrorsOutputPayloadBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _greeting = $v.greeting;
      _$v = null;
  ...
  @override
  _$GreetingWithErrorsOutputPayload build() {
    final _$result =
        _$v ?? new _$GreetingWithErrorsOutputPayload._(greeting: greeting);
    replace(_$result);
    return _$result;
  }
}
