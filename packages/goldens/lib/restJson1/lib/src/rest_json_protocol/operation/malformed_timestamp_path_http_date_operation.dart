...
library rest_json1.rest_json_protocol.operation.malformed_timestamp_path_http_date_operation;
...
class MalformedTimestampPathHttpDateOperation extends _i1.HttpOperation<
    ...
    _i1.Unit,
    _i1.Unit> {
  MalformedTimestampPathHttpDateOperation({Uri? baseUri, required this.region})
      : _baseUri = baseUri;
