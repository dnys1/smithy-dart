...
library rest_xml.rest_xml_protocol.test.http_request_with_greedy_label_in_path_operation_test_test;
    ...
    () async {
      await _i2.httpRequestTest(
          ...
          inputSerializers: const [
            _HttpRequestWithGreedyLabelInPathInputRestXmlSerializer()
          ]);
    },
  );
}

class _HttpRequestWithGreedyLabelInPathInputRestXmlSerializer extends _i4
    .StructuredSmithySerializer<_i5.HttpRequestWithGreedyLabelInPathInput> {
  const _HttpRequestWithGreedyLabelInPathInputRestXmlSerializer()
