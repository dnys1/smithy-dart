...
part of rest_json1.rest_json.model.malformed_blob_input;
...
class _$MalformedBlobInputPayload extends MalformedBlobInputPayload {
  @override
  final _i2.Uint8List? blob;

  factory _$MalformedBlobInputPayload(
          [void Function(MalformedBlobInputPayloadBuilder)? updates]) =>
      (new MalformedBlobInputPayloadBuilder()..update(updates)).build();

  _$MalformedBlobInputPayload._({this.blob}) : super._();

  @override
  MalformedBlobInputPayload rebuild(
          void Function(MalformedBlobInputPayloadBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  MalformedBlobInputPayloadBuilder toBuilder() =>
      new MalformedBlobInputPayloadBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is MalformedBlobInputPayload && blob == other.blob;
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('MalformedBlobInputPayload')
          ..add('blob', blob))
        .toString();
  }
}

class MalformedBlobInputPayloadBuilder
    implements
        Builder<MalformedBlobInputPayload, MalformedBlobInputPayloadBuilder> {
  _$MalformedBlobInputPayload? _$v;

  _i2.Uint8List? _blob;
  _i2.Uint8List? get blob => _$this._blob;
  set blob(_i2.Uint8List? blob) => _$this._blob = blob;

  MalformedBlobInputPayloadBuilder() {
    MalformedBlobInputPayload._init(this);
  }

  MalformedBlobInputPayloadBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _blob = $v.blob;
      _$v = null;
  ...
  @override
  void replace(MalformedBlobInputPayload other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$MalformedBlobInputPayload;
  }

  @override
  void update(void Function(MalformedBlobInputPayloadBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  _$MalformedBlobInputPayload build() {
    final _$result = _$v ?? new _$MalformedBlobInputPayload._(blob: blob);
    replace(_$result);
    return _$result;
  }
}
