...
part of rest_json1.rest_json.model.json_timestamps_input_output;
...
class _$JsonTimestampsInputOutput extends JsonTimestampsInputOutput {
  ...
  factory _$JsonTimestampsInputOutput(
      ...
      (new JsonTimestampsInputOutputBuilder()..update(updates)).build();
...
class JsonTimestampsInputOutputBuilder
  ...
  @override
  _$JsonTimestampsInputOutput build() {
    final _$result = _$v ??
...
class _$JsonTimestampsInputOutputPayload
    extends JsonTimestampsInputOutputPayload {
  @override
  final DateTime? dateTime;
  @override
  final DateTime? epochSeconds;
  ...
  factory _$JsonTimestampsInputOutputPayload(
          [void Function(JsonTimestampsInputOutputPayloadBuilder)? updates]) =>
      (new JsonTimestampsInputOutputPayloadBuilder()..update(updates)).build();

  _$JsonTimestampsInputOutputPayload._(
      {this.dateTime, this.epochSeconds, this.httpDate, this.normal})
      : super._();

  @override
  JsonTimestampsInputOutputPayload rebuild(
          void Function(JsonTimestampsInputOutputPayloadBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  JsonTimestampsInputOutputPayloadBuilder toBuilder() =>
      new JsonTimestampsInputOutputPayloadBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is JsonTimestampsInputOutputPayload &&
        dateTime == other.dateTime &&
        epochSeconds == other.epochSeconds &&
        httpDate == other.httpDate &&
        normal == other.normal;
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('JsonTimestampsInputOutputPayload')
          ..add('dateTime', dateTime)
          ..add('epochSeconds', epochSeconds)
          ..add('httpDate', httpDate)
          ..add('normal', normal))
...
class JsonTimestampsInputOutputPayloadBuilder
    implements
        Builder<JsonTimestampsInputOutputPayload,
            JsonTimestampsInputOutputPayloadBuilder> {
  _$JsonTimestampsInputOutputPayload? _$v;
  ...
  JsonTimestampsInputOutputPayloadBuilder() {
    JsonTimestampsInputOutputPayload._init(this);
  }

  JsonTimestampsInputOutputPayloadBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _dateTime = $v.dateTime;
      _epochSeconds = $v.epochSeconds;
  ...
  @override
  void replace(JsonTimestampsInputOutputPayload other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$JsonTimestampsInputOutputPayload;
  }

  @override
  void update(void Function(JsonTimestampsInputOutputPayloadBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  _$JsonTimestampsInputOutputPayload build() {
    final _$result = _$v ??
        new _$JsonTimestampsInputOutputPayload._(
            dateTime: dateTime,
            epochSeconds: epochSeconds,
            httpDate: httpDate,
            normal: normal);
