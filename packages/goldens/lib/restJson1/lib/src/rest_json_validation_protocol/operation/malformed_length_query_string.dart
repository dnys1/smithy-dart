...
library rest_json1.rest_json_validation_protocol.operation.malformed_length_query_string;
...
class MalformedLengthQueryStringOperation extends _i1.HttpOperation<
    ...
    _i1.Unit,
    _i1.Unit> {
  MalformedLengthQueryStringOperation({Uri? baseUri, required this.region})
      : _baseUri = baseUri;
