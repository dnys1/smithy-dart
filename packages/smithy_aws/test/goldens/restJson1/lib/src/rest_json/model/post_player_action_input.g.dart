...
class _$PostPlayerActionInputPayload extends PostPlayerActionInputPayload {
  @override
  final _i2.PlayerAction action;

  factory _$PostPlayerActionInputPayload(
          [void Function(PostPlayerActionInputPayloadBuilder)? updates]) =>
      (new PostPlayerActionInputPayloadBuilder()..update(updates)).build();

  _$PostPlayerActionInputPayload._({required this.action}) : super._() {
    BuiltValueNullFieldError.checkNotNull(
        action, 'PostPlayerActionInputPayload', 'action');
  }

  @override
  PostPlayerActionInputPayload rebuild(
          void Function(PostPlayerActionInputPayloadBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  PostPlayerActionInputPayloadBuilder toBuilder() =>
      new PostPlayerActionInputPayloadBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is PostPlayerActionInputPayload && action == other.action;
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('PostPlayerActionInputPayload')
          ..add('action', action))
        .toString();
  }
}

class PostPlayerActionInputPayloadBuilder
    implements
        Builder<PostPlayerActionInputPayload,
            PostPlayerActionInputPayloadBuilder> {
  _$PostPlayerActionInputPayload? _$v;
  ...
  PostPlayerActionInputPayloadBuilder() {
    PostPlayerActionInputPayload._init(this);
  }

  PostPlayerActionInputPayloadBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _action = $v.action;
      _$v = null;
  ...
  @override
  void replace(PostPlayerActionInputPayload other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$PostPlayerActionInputPayload;
  }

  @override
  void update(void Function(PostPlayerActionInputPayloadBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  _$PostPlayerActionInputPayload build() {
    final _$result = _$v ??
        new _$PostPlayerActionInputPayload._(
            action: BuiltValueNullFieldError.checkNotNull(
                action, 'PostPlayerActionInputPayload', 'action'));
    replace(_$result);
    return _$result;
