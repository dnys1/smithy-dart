...
library rest_xml.rest_xml_protocol.test.query_precedence_operation_test_test;
    ...
    () async {
      await _i2.httpRequestTest(
          ...
          testCase: const _i2.HttpRequestTestCase(
              ...
              forbidQueryParams: [],
              requireQueryParams: []),
          inputSerializers: const [_QueryPrecedenceInputRestXmlSerializer()]);
    },
  );
}

class _QueryPrecedenceInputRestXmlSerializer
    extends _i4.StructuredSmithySerializer<_i5.QueryPrecedenceInput> {
  const _QueryPrecedenceInputRestXmlSerializer()
