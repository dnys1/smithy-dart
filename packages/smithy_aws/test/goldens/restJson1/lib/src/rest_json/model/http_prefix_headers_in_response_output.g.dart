...
part of rest_json1.rest_json.model.http_prefix_headers_in_response_output;
...
class _$HttpPrefixHeadersInResponseOutput
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('HttpPrefixHeadersInResponseOutput')
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'HttpPrefixHeadersInResponseOutput', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
