...
library rest_json1.rest_json_validation_protocol.model.malformed_length_override_input;
...
abstract class MalformedLengthOverrideInput
  ...
  @override
  String toString() {
    final helper = newBuiltValueToStringHelper(r'MalformedLengthOverrideInput');
...
class _MalformedLengthOverrideInputRestJson1Serializer
    extends _i1.StructuredSmithySerializer<MalformedLengthOverrideInput> {
  const _MalformedLengthOverrideInputRestJson1Serializer()
