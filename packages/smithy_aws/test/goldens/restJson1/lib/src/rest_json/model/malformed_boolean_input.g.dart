...
part of rest_json1.rest_json.model.malformed_boolean_input;
...
class _$MalformedBooleanInput extends MalformedBooleanInput {
  ...
  factory _$MalformedBooleanInput(
      ...
      (new MalformedBooleanInputBuilder()..update(updates)).build();
  ...
  _$MalformedBooleanInput._(
    ...
    BuiltValueNullFieldError.checkNotNull(
        booleanInPath, 'MalformedBooleanInput', 'booleanInPath');
  }
...
class _$MalformedBooleanInputPayload extends MalformedBooleanInputPayload {
  ...
  factory _$MalformedBooleanInputPayload(
      ...
      (new MalformedBooleanInputPayloadBuilder()..update(updates)).build();
...
class MalformedBooleanInputPayloadBuilder
  ...
  @override
  _$MalformedBooleanInputPayload build() {
    final _$result = _$v ??
