...
part of rest_json1.rest_json_validation_protocol.model.file_config_settings;
...
class _$FileConfigSettings extends FileConfigSettings {
  ...
  factory _$FileConfigSettings(
      ...
      (new FileConfigSettingsBuilder()..update(updates)).build();
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'FileConfigSettings', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
