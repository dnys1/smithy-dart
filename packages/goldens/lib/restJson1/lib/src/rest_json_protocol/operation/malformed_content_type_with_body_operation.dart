...
library rest_json1.rest_json_protocol.operation.malformed_content_type_with_body_operation;
...
class MalformedContentTypeWithBodyOperation extends _i1
  ...
  MalformedContentTypeWithBodyOperation({Uri? baseUri, required this.region})
      : _baseUri = baseUri;
