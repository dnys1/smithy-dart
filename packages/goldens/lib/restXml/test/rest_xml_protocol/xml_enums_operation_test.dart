...
library rest_xml.rest_xml_protocol.test.xml_enums_operation_test;
...
import 'package:rest_xml/src/rest_xml_protocol/model/xml_enums_input_output.dart'
    as _i5;
import 'package:rest_xml/src/rest_xml_protocol/operation/xml_enums.dart' as _i3;
    ...
    () async {
      await _i2.httpRequestTest(
          ...
          testCase: const _i2.HttpRequestTestCase(
              ...
              forbidQueryParams: [],
              requireQueryParams: []),
          inputSerializers: const [_XmlEnumsInputOutputRestXmlSerializer()]);
    },
  );
  _i1.test(
    'XmlEnums (response)',
    () async {
      await _i2.httpResponseTest(
          ...
          testCase: const _i2.HttpResponseTestCase(
              ...
              appliesTo: null,
              code: 200),
          outputSerializers: const [_XmlEnumsInputOutputRestXmlSerializer()]);
    },
  );
}

class _XmlEnumsInputOutputRestXmlSerializer
    extends _i4.StructuredSmithySerializer<_i5.XmlEnumsInputOutput> {
  const _XmlEnumsInputOutputRestXmlSerializer() : super('XmlEnumsInputOutput');
