...
part of rest_json1.rest_json.model.malformed_set_input;
...
class _$MalformedSetInputPayload extends MalformedSetInputPayload {
  @override
  final _i2.BuiltSet<String>? set;

  factory _$MalformedSetInputPayload(
          [void Function(MalformedSetInputPayloadBuilder)? updates]) =>
      (new MalformedSetInputPayloadBuilder()..update(updates)).build();

  _$MalformedSetInputPayload._({this.set}) : super._();

  @override
  MalformedSetInputPayload rebuild(
          void Function(MalformedSetInputPayloadBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  MalformedSetInputPayloadBuilder toBuilder() =>
      new MalformedSetInputPayloadBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is MalformedSetInputPayload && set == other.set;
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('MalformedSetInputPayload')
          ..add('set', set))
        .toString();
  }
}

class MalformedSetInputPayloadBuilder
    implements
        Builder<MalformedSetInputPayload, MalformedSetInputPayloadBuilder> {
  _$MalformedSetInputPayload? _$v;

  _i2.BuiltSet<String>? _set;
  _i2.BuiltSet<String>? get set => _$this._set;
  set set(_i2.BuiltSet<String>? set) => _$this._set = set;

  MalformedSetInputPayloadBuilder() {
    MalformedSetInputPayload._init(this);
  }

  MalformedSetInputPayloadBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _set = $v.set;
      _$v = null;
  ...
  @override
  void replace(MalformedSetInputPayload other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$MalformedSetInputPayload;
  }

  @override
  void update(void Function(MalformedSetInputPayloadBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  _$MalformedSetInputPayload build() {
    final _$result = _$v ?? new _$MalformedSetInputPayload._(set: set);
    replace(_$result);
    return _$result;
  }
}
