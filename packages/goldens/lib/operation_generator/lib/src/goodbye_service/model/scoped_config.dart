...
library operation_generator.goodbye_service.model.scoped_config;
...
abstract class ScopedConfig
  ...
  static const List<_i2.SmithySerializer> serializers = [
    _ScopedConfigAwsJson11Serializer()
  ];
...
class _ScopedConfigAwsJson11Serializer
    extends _i2.StructuredSmithySerializer<ScopedConfig> {
  const _ScopedConfigAwsJson11Serializer() : super('ScopedConfig');
