    ...
    () async {
      await _i2.httpRequestTest(
          ...
          inputSerializers: const [
            ...
            _RecursiveShapesInputOutputNested1RestXmlSerializer(),
...
class _RecursiveShapesInputOutputNested1RestXmlSerializer extends _i4
    .StructuredSmithySerializer<_i6.RecursiveShapesInputOutputNested1> {
  const _RecursiveShapesInputOutputNested1RestXmlSerializer()
...
class _RecursiveShapesInputOutputNested2RestXmlSerializer extends _i4
    .StructuredSmithySerializer<_i7.RecursiveShapesInputOutputNested2> {
  const _RecursiveShapesInputOutputNested2RestXmlSerializer()
