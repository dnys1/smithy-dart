...
enum Int64Format { number, string }

class Int64Serializer implements PrimitiveSerializer<Int64> {
  const Int64Serializer._(this.format);

  final Int64Format format;

  static const asNum = Int64Serializer._(Int64Format.number);
  static const asString = Int64Serializer._(Int64Format.string);
  ...
  Object serialize(Serializers serializers, Int64 int64,
    ...
    return format == Int64Format.number ? int64.toInt() : int64.toString();
  }

  @override
  Int64 deserialize(Serializers serializers, Object? serialized,
      {FullType specifiedType = FullType.unspecified}) {
    return format == Int64Format.number
