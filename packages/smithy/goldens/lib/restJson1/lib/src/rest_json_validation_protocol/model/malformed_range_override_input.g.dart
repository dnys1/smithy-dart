...
class _$MalformedRangeOverrideInput extends MalformedRangeOverrideInput {
  ...
  _$MalformedRangeOverrideInput._(
    ...
    BuiltValueNullFieldError.checkNotNull(
        byte, r'MalformedRangeOverrideInput', 'byte');
    BuiltValueNullFieldError.checkNotNull(
        float, r'MalformedRangeOverrideInput', 'float');
    BuiltValueNullFieldError.checkNotNull(
        maxByte, r'MalformedRangeOverrideInput', 'maxByte');
    BuiltValueNullFieldError.checkNotNull(
        maxFloat, r'MalformedRangeOverrideInput', 'maxFloat');
    BuiltValueNullFieldError.checkNotNull(
        minByte, r'MalformedRangeOverrideInput', 'minByte');
    BuiltValueNullFieldError.checkNotNull(
        minFloat, r'MalformedRangeOverrideInput', 'minFloat');
  }
