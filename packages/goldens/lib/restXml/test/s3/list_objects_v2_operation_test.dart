...
void main() {
  final vendorSerializers = (_i1.testSerializers.toBuilder()
        ..addAll(const [
          ...
          _EnvironmentConfigSerializer(),
          _FileConfigSettingsSerializer(),
          _S3ConfigSerializer(),
    ...
    () async {
      ...
      await _i1.httpRequestTest(
          ...
          testCase: const _i1.HttpRequestTestCase(
              ...
              forbidQueryParams: [],
              requireQueryParams: []),
          inputSerializers: const [_ListObjectsV2RequestRestXmlSerializer()]);
    },
  );
  _i7.test(
...
class _ListObjectsV2RequestRestXmlSerializer
    extends _i12.StructuredSmithySerializer<_i13.ListObjectsV2Request> {
  const _ListObjectsV2RequestRestXmlSerializer()
...
class _ListObjectsV2OutputRestXmlSerializer
    extends _i12.StructuredSmithySerializer<_i14.ListObjectsV2Output> {
  const _ListObjectsV2OutputRestXmlSerializer() : super('ListObjectsV2Output');
...
class _OwnerRestXmlSerializer
    extends _i12.StructuredSmithySerializer<_i18.Owner> {
  const _OwnerRestXmlSerializer() : super('Owner');
...
class _ScopedConfigSerializer
    extends _i12.StructuredSmithySerializer<_i20.ScopedConfig> {
  const _ScopedConfigSerializer() : super('ScopedConfig');
...
class _EnvironmentConfigSerializer
    extends _i12.StructuredSmithySerializer<_i23.EnvironmentConfig> {
  const _EnvironmentConfigSerializer() : super('EnvironmentConfig');
...
class _FileConfigSettingsSerializer
    extends _i12.StructuredSmithySerializer<_i22.FileConfigSettings> {
  const _FileConfigSettingsSerializer() : super('FileConfigSettings');
...
class _S3ConfigSerializer
    extends _i12.StructuredSmithySerializer<_i25.S3Config> {
  const _S3ConfigSerializer() : super('S3Config');
...
class _OperationConfigSerializer
    extends _i12.StructuredSmithySerializer<_i24.OperationConfig> {
  const _OperationConfigSerializer() : super('OperationConfig');
