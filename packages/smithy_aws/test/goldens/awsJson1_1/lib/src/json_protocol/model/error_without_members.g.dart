...
class _$ErrorWithoutMembersPayload extends ErrorWithoutMembersPayload {
  factory _$ErrorWithoutMembersPayload(
          [void Function(ErrorWithoutMembersPayloadBuilder)? updates]) =>
      (new ErrorWithoutMembersPayloadBuilder()..update(updates)).build();

  _$ErrorWithoutMembersPayload._() : super._();

  @override
  ErrorWithoutMembersPayload rebuild(
          void Function(ErrorWithoutMembersPayloadBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  ErrorWithoutMembersPayloadBuilder toBuilder() =>
      new ErrorWithoutMembersPayloadBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is ErrorWithoutMembersPayload;
  }
  ...
  @override
  String toString() {
    return newBuiltValueToStringHelper('ErrorWithoutMembersPayload').toString();
  }
}

class ErrorWithoutMembersPayloadBuilder
    implements
        Builder<ErrorWithoutMembersPayload, ErrorWithoutMembersPayloadBuilder> {
  _$ErrorWithoutMembersPayload? _$v;

  ErrorWithoutMembersPayloadBuilder() {
    ErrorWithoutMembersPayload._init(this);
  }

  @override
  void replace(ErrorWithoutMembersPayload other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$ErrorWithoutMembersPayload;
  }

  @override
  void update(void Function(ErrorWithoutMembersPayloadBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  _$ErrorWithoutMembersPayload build() {
    final _$result = _$v ?? new _$ErrorWithoutMembersPayload._();
    replace(_$result);
    return _$result;
  }
}
