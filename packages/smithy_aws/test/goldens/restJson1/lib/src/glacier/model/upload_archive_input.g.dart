...
class _$UploadArchiveInput extends UploadArchiveInput {
  ...
  factory _$UploadArchiveInput(
      ...
      (new UploadArchiveInputBuilder()..update(updates)).build();
  ...
  _$UploadArchiveInput._(
    ...
    BuiltValueNullFieldError.checkNotNull(
        accountId, 'UploadArchiveInput', 'accountId');
    BuiltValueNullFieldError.checkNotNull(
        vaultName, 'UploadArchiveInput', 'vaultName');
  }
