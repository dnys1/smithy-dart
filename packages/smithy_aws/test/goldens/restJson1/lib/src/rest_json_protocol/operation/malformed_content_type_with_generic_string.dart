...
library rest_json1.rest_json_protocol.operation.malformed_content_type_with_generic_string;
...
class MalformedContentTypeWithGenericStringOperation extends _i1.HttpOperation<
    ...
    _i1.Unit,
    _i1.Unit> {
  MalformedContentTypeWithGenericStringOperation({required this.region});
