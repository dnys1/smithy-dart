...
part of rest_json1.rest_json_validation_protocol.model.malformed_length_query_string_input;
...
class _$MalformedLengthQueryStringInput
  ...
  factory _$MalformedLengthQueryStringInput(
      ...
      (new MalformedLengthQueryStringInputBuilder()..update(updates)).build();
...
class MalformedLengthQueryStringInputBuilder
  ...
  @override
  _$MalformedLengthQueryStringInput build() {
    final _$result =
...
class MalformedLengthQueryStringInputPayloadBuilder
  ...
  @override
  _$MalformedLengthQueryStringInputPayload build() {
