...
library rest_xml.rest_xml_protocol.test.http_payload_with_member_xml_name_operation_test_test;
...
class _HttpPayloadWithMemberXmlNameInputOutputRestXmlSerializer extends _i4
    .StructuredSmithySerializer<_i5.HttpPayloadWithMemberXmlNameInputOutput> {
  const _HttpPayloadWithMemberXmlNameInputOutputRestXmlSerializer()
...
class _PayloadWithXmlNameRestXmlSerializer
    extends _i4.StructuredSmithySerializer<_i6.PayloadWithXmlName> {
  const _PayloadWithXmlNameRestXmlSerializer() : super('PayloadWithXmlName');
