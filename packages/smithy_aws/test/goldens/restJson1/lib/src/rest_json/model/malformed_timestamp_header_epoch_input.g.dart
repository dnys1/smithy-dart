...
part of rest_json1.rest_json.model.malformed_timestamp_header_epoch_input;
...
class _$MalformedTimestampHeaderEpochInput
  ...
  _$MalformedTimestampHeaderEpochInput._({required this.timestamp})
    ...
    BuiltValueNullFieldError.checkNotNull(
        timestamp, 'MalformedTimestampHeaderEpochInput', 'timestamp');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('MalformedTimestampHeaderEpochInput')
...
class MalformedTimestampHeaderEpochInputBuilder
  ...
  @override
  _$MalformedTimestampHeaderEpochInput build() {
    final _$result = _$v ??
...
class MalformedTimestampHeaderEpochInputPayloadBuilder
  ...
  @override
  _$MalformedTimestampHeaderEpochInputPayload build() {
