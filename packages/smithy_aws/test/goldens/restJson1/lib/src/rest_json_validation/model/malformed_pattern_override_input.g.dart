...
part of rest_json1.rest_json_validation.model.malformed_pattern_override_input;
...
class _$MalformedPatternOverrideInput extends MalformedPatternOverrideInput {
  ...
  factory _$MalformedPatternOverrideInput(
      ...
      (new MalformedPatternOverrideInputBuilder()..update(updates)).build();
...
class MalformedPatternOverrideInputBuilder
  ...
  @override
  _$MalformedPatternOverrideInput build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'MalformedPatternOverrideInput', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
