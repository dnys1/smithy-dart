...
library rest_xml.rest_xml_protocol.model.aws_config;

import 'package:aws_common/aws_common.dart' as _i1;
import 'package:built_value/built_value.dart';
import 'package:built_value/serializer.dart';
import 'package:rest_xml/src/rest_xml_protocol/model/scoped_config.dart' as _i3;
...
class _AwsConfigRestXmlSerializer
    extends _i2.StructuredSmithySerializer<AwsConfig> {
  const _AwsConfigRestXmlSerializer() : super('AwsConfig');
  ...
  Iterable<Object?> serialize(Serializers serializers, Object? object,
    ...
    final result = <Object?>[_i2.XmlElementName('AwsConfig')];
