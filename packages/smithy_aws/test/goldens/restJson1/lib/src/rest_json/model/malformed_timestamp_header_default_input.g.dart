...
part of rest_json1.rest_json.model.malformed_timestamp_header_default_input;
...
class _$MalformedTimestampHeaderDefaultInput
  ...
  _$MalformedTimestampHeaderDefaultInput._({required this.timestamp})
    ...
    BuiltValueNullFieldError.checkNotNull(
        timestamp, 'MalformedTimestampHeaderDefaultInput', 'timestamp');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('MalformedTimestampHeaderDefaultInput')
...
class MalformedTimestampHeaderDefaultInputPayloadBuilder
  ...
  @override
  _$MalformedTimestampHeaderDefaultInputPayload build() {
    final _$result =
