...
library rest_json1.rest_json_validation_protocol.operation.malformed_pattern_override_operation;
...
class MalformedPatternOverrideOperation extends _i1.HttpOperation<
    ...
    _i1.Unit,
    _i1.Unit> {
  MalformedPatternOverrideOperation({Uri? baseUri, required this.region})
      : _baseUri = baseUri;
