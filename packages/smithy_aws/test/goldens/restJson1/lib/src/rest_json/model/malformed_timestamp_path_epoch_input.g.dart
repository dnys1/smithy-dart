...
part of rest_json1.rest_json.model.malformed_timestamp_path_epoch_input;
...
class _$MalformedTimestampPathEpochInput
  ...
  factory _$MalformedTimestampPathEpochInput(
      ...
      (new MalformedTimestampPathEpochInputBuilder()..update(updates)).build();

  _$MalformedTimestampPathEpochInput._({required this.timestamp}) : super._() {
    BuiltValueNullFieldError.checkNotNull(
        timestamp, 'MalformedTimestampPathEpochInput', 'timestamp');
  }
...
class MalformedTimestampPathEpochInputBuilder
  ...
  @override
  _$MalformedTimestampPathEpochInput build() {
    final _$result = _$v ??
...
class MalformedTimestampPathEpochInputPayloadBuilder
  ...
  @override
  _$MalformedTimestampPathEpochInputPayload build() {
