...
library rest_json1.rest_json_protocol.operation.malformed_timestamp_query_default_operation;
...
class MalformedTimestampQueryDefaultOperation extends _i1.HttpOperation<
    ...
    _i1.Unit,
    _i1.Unit> {
  MalformedTimestampQueryDefaultOperation({Uri? baseUri, required this.region})
      : _baseUri = baseUri;
