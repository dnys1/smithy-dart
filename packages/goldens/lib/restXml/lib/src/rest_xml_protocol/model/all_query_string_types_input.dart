...
abstract class AllQueryStringTypesInput
  ...
  factory AllQueryStringTypesInput.fromRequest(
    ...
    if (request.queryParameters['EnumList'] != null) {
      builder.queryEnumList.addAll(_i1
