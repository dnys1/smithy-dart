...
library rest_xml.rest_xml_protocol.test.http_response_code_operation_test_test;
...
class _HttpResponseCodeOutputRestXmlSerializer
    extends _i4.StructuredSmithySerializer<_i5.HttpResponseCodeOutput> {
  const _HttpResponseCodeOutputRestXmlSerializer()
