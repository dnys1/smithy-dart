...
library rest_xml.rest_xml_protocol.test.http_payload_with_xml_namespace_and_prefix_operation_test_test;
...
class _HttpPayloadWithXmlNamespaceAndPrefixInputOutputRestXmlSerializer
    extends _i4.StructuredSmithySerializer<
        _i5.HttpPayloadWithXmlNamespaceAndPrefixInputOutput> {
  const _HttpPayloadWithXmlNamespaceAndPrefixInputOutputRestXmlSerializer()
...
class _PayloadWithXmlNamespaceAndPrefixRestXmlSerializer extends _i4
    .StructuredSmithySerializer<_i6.PayloadWithXmlNamespaceAndPrefix> {
  const _PayloadWithXmlNamespaceAndPrefixRestXmlSerializer()
