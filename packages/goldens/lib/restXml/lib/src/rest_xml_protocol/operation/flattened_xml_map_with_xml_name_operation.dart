...
library rest_xml.rest_xml_protocol.operation.flattened_xml_map_with_xml_name_operation;
...
class FlattenedXmlMapWithXmlNameOperation extends _i1.HttpOperation<
    ...
    _i2.FlattenedXmlMapWithXmlNameInputOutput> {
  /// Flattened maps with @xmlName
  FlattenedXmlMapWithXmlNameOperation({Uri? baseUri, required this.region})
      : _baseUri = baseUri;
