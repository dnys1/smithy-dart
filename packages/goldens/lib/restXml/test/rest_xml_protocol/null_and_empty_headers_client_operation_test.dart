...
library rest_xml.rest_xml_protocol.test.null_and_empty_headers_client_operation_test_test;
    ...
    () async {
      await _i2.httpRequestTest(
          ...
          testCase: const _i2.HttpRequestTestCase(
              ...
              forbidQueryParams: [],
              requireQueryParams: []),
          inputSerializers: const [_NullAndEmptyHeadersIoRestXmlSerializer()]);
    },
  );
}

class _NullAndEmptyHeadersIoRestXmlSerializer
    extends _i4.StructuredSmithySerializer<_i5.NullAndEmptyHeadersIo> {
  const _NullAndEmptyHeadersIoRestXmlSerializer()
