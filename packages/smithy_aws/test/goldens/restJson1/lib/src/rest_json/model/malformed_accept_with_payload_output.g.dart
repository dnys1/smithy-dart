...
part of rest_json1.rest_json.model.malformed_accept_with_payload_output;
...
class _$MalformedAcceptWithPayloadOutput
  ...
  factory _$MalformedAcceptWithPayloadOutput(
      ...
      (new MalformedAcceptWithPayloadOutputBuilder()..update(updates)).build();
...
class MalformedAcceptWithPayloadOutputBuilder
  ...
  @override
  _$MalformedAcceptWithPayloadOutput build() {
    final _$result =
