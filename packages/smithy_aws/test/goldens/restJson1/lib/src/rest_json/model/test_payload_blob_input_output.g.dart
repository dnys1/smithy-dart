...
part of rest_json1.rest_json.model.test_payload_blob_input_output;
...
class _$TestPayloadBlobInputOutput extends TestPayloadBlobInputOutput {
  ...
  factory _$TestPayloadBlobInputOutput(
      ...
      (new TestPayloadBlobInputOutputBuilder()..update(updates)).build();
...
class TestPayloadBlobInputOutputBuilder
  ...
  @override
  _$TestPayloadBlobInputOutput build() {
    final _$result = _$v ??
