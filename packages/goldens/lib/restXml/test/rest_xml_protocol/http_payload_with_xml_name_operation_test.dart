...
library rest_xml.rest_xml_protocol.test.http_payload_with_xml_name_operation_test_test;
...
class _HttpPayloadWithXmlNameInputOutputRestXmlSerializer extends _i4
    .StructuredSmithySerializer<_i5.HttpPayloadWithXmlNameInputOutput> {
  const _HttpPayloadWithXmlNameInputOutputRestXmlSerializer()
