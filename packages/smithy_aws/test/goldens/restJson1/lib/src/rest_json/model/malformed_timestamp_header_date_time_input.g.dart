...
part of rest_json1.rest_json.model.malformed_timestamp_header_date_time_input;
...
class _$MalformedTimestampHeaderDateTimeInput
  ...
  _$MalformedTimestampHeaderDateTimeInput._({required this.timestamp})
    ...
    BuiltValueNullFieldError.checkNotNull(
        timestamp, 'MalformedTimestampHeaderDateTimeInput', 'timestamp');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('MalformedTimestampHeaderDateTimeInput')
...
class MalformedTimestampHeaderDateTimeInputPayloadBuilder
  ...
  @override
  _$MalformedTimestampHeaderDateTimeInputPayload build() {
    final _$result =
