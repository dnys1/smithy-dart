...
library rest_json1.rest_json_validation.model.pattern_union;
...
class _PatternUnionRestJson1Serializer
  ...
  PatternUnion deserialize(
    ...
    switch (key) {
      case 'first':
        return _PatternUnionFirst((serializers.deserialize(value,
            specifiedType: const FullType(String)) as String));
      case 'second':
        return _PatternUnionSecond((serializers.deserialize(value,
            specifiedType: const FullType(String)) as String));
    }
    return _PatternUnionSdkUnknown(key, value);
  }
