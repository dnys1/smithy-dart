...
library rest_json1.rest_json_protocol.operation.malformed_timestamp_body_date_time_operation;
...
class MalformedTimestampBodyDateTimeOperation extends _i1.HttpOperation<
    ...
    _i1.Unit,
    _i1.Unit> {
  MalformedTimestampBodyDateTimeOperation({Uri? baseUri, required this.region})
      : _baseUri = baseUri;
