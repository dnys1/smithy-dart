...
library aws_json1_0.json_rpc_10.model.environment_config;
...
class _EnvironmentConfigAwsJson10Serializer
    extends _i3.StructuredSmithySerializer<EnvironmentConfig> {
  const _EnvironmentConfigAwsJson10Serializer() : super('EnvironmentConfig');
