...
library rest_json1.rest_json_validation_protocol.operation.sensitive_validation_operation;
...
class SensitiveValidationOperation extends _i1.HttpOperation<
    ...
    _i1.Unit,
    _i1.Unit> {
  SensitiveValidationOperation({Uri? baseUri, required this.region})
      : _baseUri = baseUri;
