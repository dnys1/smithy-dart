...
library aws_json1_1.json_protocol.model.my_union;
...
class _MyUnionAwsJson11Serializer
    extends _i1.StructuredSmithySerializer<MyUnion> {
  const _MyUnionAwsJson11Serializer() : super('MyUnion');
