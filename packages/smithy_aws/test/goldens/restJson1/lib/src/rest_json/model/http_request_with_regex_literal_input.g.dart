...
part of rest_json1.rest_json.model.http_request_with_regex_literal_input;
...
class _$HttpRequestWithRegexLiteralInput
  ...
  factory _$HttpRequestWithRegexLiteralInput(
      ...
      (new HttpRequestWithRegexLiteralInputBuilder()..update(updates)).build();

  _$HttpRequestWithRegexLiteralInput._({required this.str}) : super._() {
    BuiltValueNullFieldError.checkNotNull(
        str, 'HttpRequestWithRegexLiteralInput', 'str');
  }
...
class HttpRequestWithRegexLiteralInputBuilder
  ...
  @override
  _$HttpRequestWithRegexLiteralInput build() {
    final _$result = _$v ??
...
class HttpRequestWithRegexLiteralInputPayloadBuilder
  ...
  @override
  _$HttpRequestWithRegexLiteralInputPayload build() {
