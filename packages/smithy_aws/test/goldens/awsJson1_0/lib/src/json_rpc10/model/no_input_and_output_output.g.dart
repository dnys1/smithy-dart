...
class _$NoInputAndOutputOutputPayload extends NoInputAndOutputOutputPayload {
  factory _$NoInputAndOutputOutputPayload(
          [void Function(NoInputAndOutputOutputPayloadBuilder)? updates]) =>
      (new NoInputAndOutputOutputPayloadBuilder()..update(updates)).build();

  _$NoInputAndOutputOutputPayload._() : super._();

  @override
  NoInputAndOutputOutputPayload rebuild(
          void Function(NoInputAndOutputOutputPayloadBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  NoInputAndOutputOutputPayloadBuilder toBuilder() =>
      new NoInputAndOutputOutputPayloadBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is NoInputAndOutputOutputPayload;
  }
  ...
  @override
  String toString() {
    return newBuiltValueToStringHelper('NoInputAndOutputOutputPayload')
        .toString();
  }
}

class NoInputAndOutputOutputPayloadBuilder
    implements
        Builder<NoInputAndOutputOutputPayload,
            NoInputAndOutputOutputPayloadBuilder> {
  _$NoInputAndOutputOutputPayload? _$v;

  NoInputAndOutputOutputPayloadBuilder() {
    NoInputAndOutputOutputPayload._init(this);
  }

  @override
  void replace(NoInputAndOutputOutputPayload other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$NoInputAndOutputOutputPayload;
  }

  @override
  void update(void Function(NoInputAndOutputOutputPayloadBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  _$NoInputAndOutputOutputPayload build() {
    final _$result = _$v ?? new _$NoInputAndOutputOutputPayload._();
    replace(_$result);
    return _$result;
  }
}
