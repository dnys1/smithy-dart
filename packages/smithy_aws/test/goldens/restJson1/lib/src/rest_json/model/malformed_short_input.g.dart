...
part of rest_json1.rest_json.model.malformed_short_input;
...
class _$MalformedShortInput extends MalformedShortInput {
  ...
  factory _$MalformedShortInput(
      ...
      (new MalformedShortInputBuilder()..update(updates)).build();
  ...
  _$MalformedShortInput._(
    ...
    BuiltValueNullFieldError.checkNotNull(
        shortInPath, 'MalformedShortInput', 'shortInPath');
  }
...
class _$MalformedShortInputPayload extends MalformedShortInputPayload {
  ...
  factory _$MalformedShortInputPayload(
      ...
      (new MalformedShortInputPayloadBuilder()..update(updates)).build();
...
class MalformedShortInputPayloadBuilder
  ...
  @override
  _$MalformedShortInputPayload build() {
    final _$result =
