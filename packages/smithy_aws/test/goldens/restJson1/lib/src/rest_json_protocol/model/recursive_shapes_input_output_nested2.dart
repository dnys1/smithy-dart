...
library rest_json1.rest_json_protocol.model.recursive_shapes_input_output_nested2;
...
abstract class RecursiveShapesInputOutputNested2
  ...
  String toString() {
    final helper =
        newBuiltValueToStringHelper(r'RecursiveShapesInputOutputNested2');
    helper.add(r'bar', bar);
    helper.add(r'recursiveMember', recursiveMember);
