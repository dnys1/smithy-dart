...
library rest_xml.rest_xml_protocol.test.xml_lists_operation_test;
...
import 'package:rest_xml/src/rest_xml_protocol/model/xml_lists_input_output.dart'
    as _i5;
import 'package:rest_xml/src/rest_xml_protocol/operation/xml_lists.dart' as _i3;
...
class _XmlListsInputOutputRestXmlSerializer
    extends _i4.StructuredSmithySerializer<_i5.XmlListsInputOutput> {
  const _XmlListsInputOutputRestXmlSerializer() : super('XmlListsInputOutput');
...
class _StructureListMemberRestXmlSerializer
    extends _i4.StructuredSmithySerializer<_i8.StructureListMember> {
  const _StructureListMemberRestXmlSerializer() : super('StructureListMember');
