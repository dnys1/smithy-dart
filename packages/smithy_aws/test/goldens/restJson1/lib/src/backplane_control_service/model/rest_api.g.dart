...
part of rest_json1.backplane_control_service.model.rest_api;
...
class _$RestApi extends RestApi {
  ...
  @override
  final _i5.EndpointConfiguration? endpointConfiguration;
  @override
  final String? id;
  @override
  ...
  factory _$RestApi([void Function(RestApiBuilder)? updates]) =>
      (new RestApiBuilder()..update(updates)).build();
...
class RestApiBuilder implements Builder<RestApi, RestApiBuilder> {
  ...
  _i5.EndpointConfigurationBuilder? _endpointConfiguration;
  _i5.EndpointConfigurationBuilder get endpointConfiguration =>
      _$this._endpointConfiguration ??= new _i5.EndpointConfigurationBuilder();
  set endpointConfiguration(
          _i5.EndpointConfigurationBuilder? endpointConfiguration) =>
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'RestApi', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
