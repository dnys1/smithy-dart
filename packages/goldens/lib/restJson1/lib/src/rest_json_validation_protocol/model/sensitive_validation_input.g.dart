...
part of rest_json1.rest_json_validation_protocol.model.sensitive_validation_input;
...
class _$SensitiveValidationInput extends SensitiveValidationInput {
  ...
  factory _$SensitiveValidationInput(
      ...
      (new SensitiveValidationInputBuilder()..update(updates)).build();
...
class SensitiveValidationInputBuilder
  ...
  @override
  _$SensitiveValidationInput build() {
