...
library aws_json1_0.json_rpc_10.model.s3_config;
...
class _S3ConfigAwsJson10Serializer
    extends _i2.StructuredSmithySerializer<S3Config> {
  const _S3ConfigAwsJson10Serializer() : super('S3Config');
