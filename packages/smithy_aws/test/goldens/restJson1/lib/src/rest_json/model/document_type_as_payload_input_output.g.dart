...
part of rest_json1.rest_json.model.document_type_as_payload_input_output;
...
class _$DocumentTypeAsPayloadInputOutput
  ...
  factory _$DocumentTypeAsPayloadInputOutput(
      ...
      (new DocumentTypeAsPayloadInputOutputBuilder()..update(updates)).build();
...
class DocumentTypeAsPayloadInputOutputBuilder
  ...
  @override
  _$DocumentTypeAsPayloadInputOutput build() {
    final _$result = _$v ??
