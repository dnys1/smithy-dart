...
library rest_json1.glacier.operation.upload_multipart_part_test;
...
class _UploadMultipartPartInputRestJson1Serializer
    extends _i4.StructuredSmithySerializer<_i5.UploadMultipartPartInput> {
  const _UploadMultipartPartInputRestJson1Serializer()
      : super('UploadMultipartPartInput');

  @override
  Iterable<Type> get types => const [_i5.UploadMultipartPartInput];
  @override
  Iterable<_i4.ShapeId> get supportedProtocols =>
      const [_i4.ShapeId(namespace: 'aws.protocols', shape: 'restJson1')];
  @override
  _i5.UploadMultipartPartInput deserialize(
      Serializers serializers, Iterable<Object?> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = _i5.UploadMultipartPartInputBuilder();
...
class _UploadMultipartPartOutputRestJson1Serializer
    extends _i4.StructuredSmithySerializer<_i7.UploadMultipartPartOutput> {
  const _UploadMultipartPartOutputRestJson1Serializer()
      : super('UploadMultipartPartOutput');

  @override
  Iterable<Type> get types => const [_i7.UploadMultipartPartOutput];
  @override
  Iterable<_i4.ShapeId> get supportedProtocols =>
      const [_i4.ShapeId(namespace: 'aws.protocols', shape: 'restJson1')];
  @override
  _i7.UploadMultipartPartOutput deserialize(
      Serializers serializers, Iterable<Object?> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = _i7.UploadMultipartPartOutputBuilder();
    final iterator = serialized.iterator;
    while (iterator.moveNext()) {
      final key = iterator.current as String;
      iterator.moveNext();
