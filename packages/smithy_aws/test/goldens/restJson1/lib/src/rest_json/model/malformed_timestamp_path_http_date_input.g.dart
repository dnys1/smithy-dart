...
part of rest_json1.rest_json.model.malformed_timestamp_path_http_date_input;
...
class _$MalformedTimestampPathHttpDateInput
  ...
  _$MalformedTimestampPathHttpDateInput._({required this.timestamp})
    ...
    BuiltValueNullFieldError.checkNotNull(
        timestamp, 'MalformedTimestampPathHttpDateInput', 'timestamp');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('MalformedTimestampPathHttpDateInput')
...
class MalformedTimestampPathHttpDateInputBuilder
  ...
  @override
  _$MalformedTimestampPathHttpDateInput build() {
    final _$result = _$v ??
...
class MalformedTimestampPathHttpDateInputPayloadBuilder
  ...
  @override
  _$MalformedTimestampPathHttpDateInputPayload build() {
    final _$result =
