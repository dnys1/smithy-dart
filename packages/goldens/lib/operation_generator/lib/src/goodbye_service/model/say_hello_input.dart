...
library operation_generator.goodbye_service.model.say_hello_input;
...
abstract class SayHelloInput
  ...
  @override
  String toString() {
    final helper = newBuiltValueToStringHelper('SayHelloInput');
    helper.add('greeting', greeting);
    helper.add('hostLabel', hostLabel);
...
abstract class SayHelloInputPayload
  ...
  @override
  String toString() {
    final helper = newBuiltValueToStringHelper('SayHelloInputPayload');
    helper.add('hostLabel', hostLabel);
    helper.add('name', name);
    return helper.toString();
  }
