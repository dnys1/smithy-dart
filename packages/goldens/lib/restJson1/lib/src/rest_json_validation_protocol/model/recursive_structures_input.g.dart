...
part of rest_json1.rest_json_validation_protocol.model.recursive_structures_input;
...
class _$RecursiveStructuresInput extends RecursiveStructuresInput {
  ...
  factory _$RecursiveStructuresInput(
      ...
      (new RecursiveStructuresInputBuilder()..update(updates)).build();
...
class RecursiveStructuresInputBuilder
  ...
  @override
  _$RecursiveStructuresInput build() {
