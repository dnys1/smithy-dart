...
class _$HttpPrefixHeadersInputOutput extends HttpPrefixHeadersInputOutput {
  ...
  factory _$HttpPrefixHeadersInputOutput(
      ...
      (new HttpPrefixHeadersInputOutputBuilder()..update(updates)).build();
...
class HttpPrefixHeadersInputOutputBuilder
  ...
  @override
  _$HttpPrefixHeadersInputOutput build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'HttpPrefixHeadersInputOutput', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
...
class HttpPrefixHeadersInputOutputPayloadBuilder
  ...
  @override
  _$HttpPrefixHeadersInputOutputPayload build() {
