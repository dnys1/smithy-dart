...
part of aws_json1_0.json_rpc10.model.simple_scalar_properties_output;
...
class _$SimpleScalarPropertiesOutput extends SimpleScalarPropertiesOutput {
  ...
  factory _$SimpleScalarPropertiesOutput(
      ...
      (new SimpleScalarPropertiesOutputBuilder()..update(updates)).build();
...
class SimpleScalarPropertiesOutputBuilder
  ...
  @override
  _$SimpleScalarPropertiesOutput build() {
    final _$result = _$v ??
...
class _$SimpleScalarPropertiesOutputPayload
    extends SimpleScalarPropertiesOutputPayload {
  @override
  final double? doubleValue;
  @override
  final double? floatValue;

  factory _$SimpleScalarPropertiesOutputPayload(
          [void Function(SimpleScalarPropertiesOutputPayloadBuilder)?
              updates]) =>
      (new SimpleScalarPropertiesOutputPayloadBuilder()..update(updates))
          .build();

  _$SimpleScalarPropertiesOutputPayload._({this.doubleValue, this.floatValue})
      : super._();

  @override
  SimpleScalarPropertiesOutputPayload rebuild(
          void Function(SimpleScalarPropertiesOutputPayloadBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  SimpleScalarPropertiesOutputPayloadBuilder toBuilder() =>
      new SimpleScalarPropertiesOutputPayloadBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is SimpleScalarPropertiesOutputPayload &&
        doubleValue == other.doubleValue &&
        floatValue == other.floatValue;
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('SimpleScalarPropertiesOutputPayload')
          ..add('doubleValue', doubleValue)
          ..add('floatValue', floatValue))
        .toString();
  }
...
class SimpleScalarPropertiesOutputPayloadBuilder
    implements
        Builder<SimpleScalarPropertiesOutputPayload,
            SimpleScalarPropertiesOutputPayloadBuilder> {
  _$SimpleScalarPropertiesOutputPayload? _$v;
  ...
  SimpleScalarPropertiesOutputPayloadBuilder() {
    SimpleScalarPropertiesOutputPayload._init(this);
  }

  SimpleScalarPropertiesOutputPayloadBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _doubleValue = $v.doubleValue;
      _floatValue = $v.floatValue;
  ...
  @override
  void replace(SimpleScalarPropertiesOutputPayload other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$SimpleScalarPropertiesOutputPayload;
  }
  ...
  @override
  _$SimpleScalarPropertiesOutputPayload build() {
    final _$result = _$v ??
        new _$SimpleScalarPropertiesOutputPayload._(
            doubleValue: doubleValue, floatValue: floatValue);
    replace(_$result);
    return _$result;
  }
