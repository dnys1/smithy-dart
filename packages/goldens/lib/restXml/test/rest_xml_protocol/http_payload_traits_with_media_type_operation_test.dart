...
library rest_xml.rest_xml_protocol.test.http_payload_traits_with_media_type_operation_test_test;
...
class _HttpPayloadTraitsWithMediaTypeInputOutputRestXmlSerializer extends _i4
    .StructuredSmithySerializer<_i5.HttpPayloadTraitsWithMediaTypeInputOutput> {
  const _HttpPayloadTraitsWithMediaTypeInputOutputRestXmlSerializer()
