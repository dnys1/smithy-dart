...
library rest_json1.rest_json_protocol.test.post_union_with_json_name_operation_test_test;
    ...
    () async {
      await _i2.httpRequestTest(
          ...
          inputSerializers: const [
            _PostUnionWithJsonNameInputRestJson1Serializer()
          ]);
    },
  );
  _i1.test(
    ...
    () async {
      await _i2.httpResponseTest(
          ...
          outputSerializers: const [
            _PostUnionWithJsonNameOutputRestJson1Serializer()
          ]);
    },
  );
  _i1.test(
...
class _PostUnionWithJsonNameInputRestJson1Serializer
    extends _i4.StructuredSmithySerializer<_i5.PostUnionWithJsonNameInput> {
  const _PostUnionWithJsonNameInputRestJson1Serializer()
...
class _PostUnionWithJsonNameOutputRestJson1Serializer
    extends _i4.StructuredSmithySerializer<_i7.PostUnionWithJsonNameOutput> {
  const _PostUnionWithJsonNameOutputRestJson1Serializer()
