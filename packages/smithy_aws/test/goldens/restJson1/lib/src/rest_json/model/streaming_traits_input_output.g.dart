...
part of rest_json1.rest_json.model.streaming_traits_input_output;
...
class _$StreamingTraitsInputOutput extends StreamingTraitsInputOutput {
  ...
  factory _$StreamingTraitsInputOutput(
      ...
      (new StreamingTraitsInputOutputBuilder()..update(updates)).build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('StreamingTraitsInputOutput')
          ..add('blob', blob)
          ..add('foo', foo))
        .toString();
  }
...
class StreamingTraitsInputOutputBuilder
  ...
  @override
  _$StreamingTraitsInputOutput build() {
    final _$result =
