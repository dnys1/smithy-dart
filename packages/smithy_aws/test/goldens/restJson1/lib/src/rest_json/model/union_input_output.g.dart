...
part of rest_json1.rest_json.model.union_input_output;
...
class _$UnionInputOutput extends UnionInputOutput {
  ...
  factory _$UnionInputOutput(
      ...
      (new UnionInputOutputBuilder()..update(updates)).build();
...
class _$UnionInputOutputPayload extends UnionInputOutputPayload {
  @override
  final _i2.MyUnion? contents;

  factory _$UnionInputOutputPayload(
          [void Function(UnionInputOutputPayloadBuilder)? updates]) =>
      (new UnionInputOutputPayloadBuilder()..update(updates)).build();

  _$UnionInputOutputPayload._({this.contents}) : super._();

  @override
  UnionInputOutputPayload rebuild(
          void Function(UnionInputOutputPayloadBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  UnionInputOutputPayloadBuilder toBuilder() =>
      new UnionInputOutputPayloadBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is UnionInputOutputPayload && contents == other.contents;
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('UnionInputOutputPayload')
          ..add('contents', contents))
        .toString();
  }
}

class UnionInputOutputPayloadBuilder
    implements
        Builder<UnionInputOutputPayload, UnionInputOutputPayloadBuilder> {
  _$UnionInputOutputPayload? _$v;

  _i2.MyUnion? _contents;
  _i2.MyUnion? get contents => _$this._contents;
  set contents(_i2.MyUnion? contents) => _$this._contents = contents;

  UnionInputOutputPayloadBuilder() {
    UnionInputOutputPayload._init(this);
  }

  UnionInputOutputPayloadBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _contents = $v.contents;
      _$v = null;
  ...
  @override
  void replace(UnionInputOutputPayload other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$UnionInputOutputPayload;
  }

  @override
  void update(void Function(UnionInputOutputPayloadBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  _$UnionInputOutputPayload build() {
    final _$result = _$v ?? new _$UnionInputOutputPayload._(contents: contents);
    replace(_$result);
    return _$result;
  }
}
