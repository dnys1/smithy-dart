...
part of rest_json1.rest_json.model.malformed_timestamp_query_epoch_input;
...
class _$MalformedTimestampQueryEpochInput
  ...
  _$MalformedTimestampQueryEpochInput._({required this.timestamp}) : super._() {
    BuiltValueNullFieldError.checkNotNull(
        timestamp, 'MalformedTimestampQueryEpochInput', 'timestamp');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('MalformedTimestampQueryEpochInput')
