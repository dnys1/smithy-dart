...
library rest_json1.rest_json.operation.http_enum_payload_test;

import 'package:built_value/serializer.dart';
import 'package:rest_json1/src/rest_json/model/enum_payload_input.dart' as _i5;
import 'package:rest_json1/src/rest_json/model/string_enum.dart' as _i6;
  ...
  _i1.test('EnumPayloadRequest (restJson1)', () async {
    await _i2.httpRequestTest(
        ...
        testCase: const _i2.HttpRequestTestCase(
            ...
            forbidQueryParams: [],
            requireQueryParams: []),
        inputSerializer: const _EnumPayloadInputRestJson1Serializer());
  });
  _i1.test('EnumPayloadResponse (restJson1)', () async {
    await _i2.httpResponseTest(
        ...
        testCase: const _i2.HttpResponseTestCase(
            ...
            appliesTo: null,
            code: 200),
        outputSerializer: const _EnumPayloadInputRestJson1Serializer());
  });
}
