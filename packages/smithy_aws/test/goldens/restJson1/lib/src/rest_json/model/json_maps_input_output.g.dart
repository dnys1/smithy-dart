...
class _$JsonMapsInputOutputPayload extends JsonMapsInputOutputPayload {
  @override
  final _i2.BuiltMap<String, bool>? denseBooleanMap;
  @override
  final _i2.BuiltMap<String, int>? denseNumberMap;
  ...
  factory _$JsonMapsInputOutputPayload(
          [void Function(JsonMapsInputOutputPayloadBuilder)? updates]) =>
      (new JsonMapsInputOutputPayloadBuilder()..update(updates)).build();

  _$JsonMapsInputOutputPayload._(
      {this.denseBooleanMap,
      this.denseNumberMap,
      this.denseSetMap,
      this.denseStringMap,
  ...
  @override
  JsonMapsInputOutputPayload rebuild(
          void Function(JsonMapsInputOutputPayloadBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  JsonMapsInputOutputPayloadBuilder toBuilder() =>
      new JsonMapsInputOutputPayloadBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is JsonMapsInputOutputPayload &&
        denseBooleanMap == other.denseBooleanMap &&
        denseNumberMap == other.denseNumberMap &&
        denseSetMap == other.denseSetMap &&
        denseStringMap == other.denseStringMap &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('JsonMapsInputOutputPayload')
          ..add('denseBooleanMap', denseBooleanMap)
          ..add('denseNumberMap', denseNumberMap)
          ..add('denseSetMap', denseSetMap)
          ..add('denseStringMap', denseStringMap)
...
class JsonMapsInputOutputPayloadBuilder
    implements
        Builder<JsonMapsInputOutputPayload, JsonMapsInputOutputPayloadBuilder> {
  _$JsonMapsInputOutputPayload? _$v;

  _i2.BuiltMap<String, bool>? _denseBooleanMap;
  _i2.BuiltMap<String, bool>? get denseBooleanMap => _$this._denseBooleanMap;
  set denseBooleanMap(_i2.BuiltMap<String, bool>? denseBooleanMap) =>
      _$this._denseBooleanMap = denseBooleanMap;

  _i2.BuiltMap<String, int>? _denseNumberMap;
  _i2.BuiltMap<String, int>? get denseNumberMap => _$this._denseNumberMap;
  set denseNumberMap(_i2.BuiltMap<String, int>? denseNumberMap) =>
      _$this._denseNumberMap = denseNumberMap;

  _i2.BuiltSetMultimap<String, String>? _denseSetMap;
  _i2.BuiltSetMultimap<String, String>? get denseSetMap => _$this._denseSetMap;
  set denseSetMap(_i2.BuiltSetMultimap<String, String>? denseSetMap) =>
      _$this._denseSetMap = denseSetMap;

  _i2.BuiltMap<String, String>? _denseStringMap;
  _i2.BuiltMap<String, String>? get denseStringMap => _$this._denseStringMap;
  set denseStringMap(_i2.BuiltMap<String, String>? denseStringMap) =>
      _$this._denseStringMap = denseStringMap;

  _i2.BuiltMap<String, _i3.GreetingStruct>? _denseStructMap;
  _i2.BuiltMap<String, _i3.GreetingStruct>? get denseStructMap =>
      _$this._denseStructMap;
  set denseStructMap(
          _i2.BuiltMap<String, _i3.GreetingStruct>? denseStructMap) =>
      _$this._denseStructMap = denseStructMap;

  _i2.BuiltMap<String, bool?>? _sparseBooleanMap;
  _i2.BuiltMap<String, bool?>? get sparseBooleanMap => _$this._sparseBooleanMap;
  set sparseBooleanMap(_i2.BuiltMap<String, bool?>? sparseBooleanMap) =>
      _$this._sparseBooleanMap = sparseBooleanMap;

  _i2.BuiltMap<String, int?>? _sparseNumberMap;
  _i2.BuiltMap<String, int?>? get sparseNumberMap => _$this._sparseNumberMap;
  set sparseNumberMap(_i2.BuiltMap<String, int?>? sparseNumberMap) =>
      _$this._sparseNumberMap = sparseNumberMap;

  _i2.BuiltSetMultimap<String, String>? _sparseSetMap;
  _i2.BuiltSetMultimap<String, String>? get sparseSetMap =>
      _$this._sparseSetMap;
  set sparseSetMap(_i2.BuiltSetMultimap<String, String>? sparseSetMap) =>
      _$this._sparseSetMap = sparseSetMap;
  ...
  _i2.BuiltMap<String, _i3.GreetingStruct?>? _sparseStructMap;
  _i2.BuiltMap<String, _i3.GreetingStruct?>? get sparseStructMap =>
      _$this._sparseStructMap;
  set sparseStructMap(
          _i2.BuiltMap<String, _i3.GreetingStruct?>? sparseStructMap) =>
      _$this._sparseStructMap = sparseStructMap;

  JsonMapsInputOutputPayloadBuilder() {
    JsonMapsInputOutputPayload._init(this);
  }

  JsonMapsInputOutputPayloadBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _denseBooleanMap = $v.denseBooleanMap;
      _denseNumberMap = $v.denseNumberMap;
      _denseSetMap = $v.denseSetMap;
      _denseStringMap = $v.denseStringMap;
      _denseStructMap = $v.denseStructMap;
      _sparseBooleanMap = $v.sparseBooleanMap;
      _sparseNumberMap = $v.sparseNumberMap;
      _sparseSetMap = $v.sparseSetMap;
      _sparseStringMap = $v.sparseStringMap;
      _sparseStructMap = $v.sparseStructMap;
      _$v = null;
    }
    return this;
  }
  ...
  @override
  void replace(JsonMapsInputOutputPayload other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$JsonMapsInputOutputPayload;
  }

  @override
  void update(void Function(JsonMapsInputOutputPayloadBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  _$JsonMapsInputOutputPayload build() {
    final _$result = _$v ??
        new _$JsonMapsInputOutputPayload._(
