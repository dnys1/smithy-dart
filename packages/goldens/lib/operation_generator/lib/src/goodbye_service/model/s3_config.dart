...
library operation_generator.goodbye_service.model.s3_config;
...
class _S3ConfigAwsJson11Serializer
    extends _i2.StructuredSmithySerializer<S3Config> {
  const _S3ConfigAwsJson11Serializer() : super('S3Config');
