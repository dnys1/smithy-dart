...
part of rest_json1.rest_json.model.string_payload_input;
...
class _$StringPayloadInput extends StringPayloadInput {
  ...
  factory _$StringPayloadInput(
      ...
      (new StringPayloadInputBuilder()..update(updates)).build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('StringPayloadInput')
          ..add('payload', payload))
        .toString();
  }
}
