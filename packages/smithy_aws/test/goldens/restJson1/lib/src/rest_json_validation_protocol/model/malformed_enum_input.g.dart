...
part of rest_json1.rest_json_validation_protocol.model.malformed_enum_input;
...
class _$MalformedEnumInput extends MalformedEnumInput {
  ...
  factory _$MalformedEnumInput(
      ...
      (new MalformedEnumInputBuilder()..update(updates)).build();
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'MalformedEnumInput', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
