...
library rest_json1.rest_json_validation_protocol.operation.recursive_structures_operation;
...
class RecursiveStructuresOperation extends _i1.HttpOperation<
    ...
    _i1.Unit,
    _i1.Unit> {
  RecursiveStructuresOperation({Uri? baseUri, required this.region})
      : _baseUri = baseUri;
