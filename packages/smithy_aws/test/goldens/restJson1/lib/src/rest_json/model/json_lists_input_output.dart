...
abstract class JsonListsInputOutput
    with _i1.HttpInput<JsonListsInputOutputPayload>
    implements
        Built<JsonListsInputOutput, JsonListsInputOutputBuilder>,
        _i1.HasPayload<JsonListsInputOutputPayload> {
  ...
  @override
  JsonListsInputOutputPayload getPayload() =>
      JsonListsInputOutputPayload((b) => b
...
abstract class JsonListsInputOutputPayload
    implements
        Built<JsonListsInputOutputPayload, JsonListsInputOutputPayloadBuilder> {
  factory JsonListsInputOutputPayload(
          [void Function(JsonListsInputOutputPayloadBuilder) updates]) =
      _$JsonListsInputOutputPayload;

  const JsonListsInputOutputPayload._();

  @BuiltValueHook(initializeBuilder: true)
  static void _init(JsonListsInputOutputPayloadBuilder b) {}
  _i2.BuiltList<bool>? get booleanList;
  _i2.BuiltList<_i3.FooEnum>? get enumList;
  _i2.BuiltList<int>? get integerList;
  _i2.BuiltList<_i2.BuiltList<String>>? get nestedStringList;
...
class _JsonListsInputOutputRestJson1Serializer
    extends _i1.StructuredSmithySerializer<JsonListsInputOutputPayload> {
  ...
  @override
  JsonListsInputOutputPayload deserialize(
      Serializers serializers, Iterable<Object?> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = JsonListsInputOutputPayloadBuilder();
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        case 'booleanList':
          if (value != null) {
            result.booleanList = (serializers.deserialize(value,
                    specifiedType:
        ...
        case 'enumList':
          if (value != null) {
            result.enumList = (serializers.deserialize(value,
                    specifiedType:
        ...
        case 'integerList':
          if (value != null) {
            result.integerList = (serializers.deserialize(value,
                    specifiedType:
        ...
        case 'nestedStringList':
          if (value != null) {
            result.nestedStringList = (serializers.deserialize(value,
        ...
        case 'sparseStringList':
          if (value != null) {
            result.sparseStringList = (serializers.deserialize(value,
        ...
        case 'stringList':
          if (value != null) {
            result.stringList = (serializers.deserialize(value,
                    specifiedType:
        ...
        case 'stringSet':
          if (value != null) {
            result.stringSet = (serializers.deserialize(value,
                    specifiedType:
        ...
        case 'myStructureList':
          if (value != null) {
            result.structureList = (serializers.deserialize(value,
                    specifiedType: const FullType(
        ...
        case 'timestampList':
          if (value != null) {
            result.timestampList = (serializers.deserialize(value,
                    specifiedType:
  ...
  Iterable<Object?> serialize(Serializers serializers, Object? object,
      {FullType specifiedType = FullType.unspecified}) {
    final payload = object is JsonListsInputOutput
        ? object.getPayload()
        : (object as JsonListsInputOutputPayload);
    final result = <Object?>[];
