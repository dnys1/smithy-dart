...
library rest_json1.rest_json_protocol.operation.http_request_with_regex_literal;
...
class HttpRequestWithRegexLiteralOperation extends _i1.HttpOperation<
    ...
    _i1.Unit,
    _i1.Unit> {
  HttpRequestWithRegexLiteralOperation({Uri? baseUri, required this.region})
      : _baseUri = baseUri;
