...
part of rest_json1.rest_json.model.http_prefix_headers_output;
...
class _$HttpPrefixHeadersOutput extends HttpPrefixHeadersOutput {
  ...
  factory _$HttpPrefixHeadersOutput(
      ...
      (new HttpPrefixHeadersOutputBuilder()..update(updates)).build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('HttpPrefixHeadersOutput')
          ..add('foo', foo)
          ..add('fooMap', fooMap))
        .toString();
  }
...
class HttpPrefixHeadersOutputBuilder
  ...
  @override
  _$HttpPrefixHeadersOutput build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'HttpPrefixHeadersOutput', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
...
class _$HttpPrefixHeadersOutputPayload extends HttpPrefixHeadersOutputPayload {
  factory _$HttpPrefixHeadersOutputPayload(
      ...
      (new HttpPrefixHeadersOutputPayloadBuilder()..update(updates)).build();
  ...
  @override
  String toString() {
    return newBuiltValueToStringHelper('HttpPrefixHeadersOutputPayload')
        .toString();
  }
}
...
class HttpPrefixHeadersOutputPayloadBuilder
  ...
  @override
  _$HttpPrefixHeadersOutputPayload build() {
