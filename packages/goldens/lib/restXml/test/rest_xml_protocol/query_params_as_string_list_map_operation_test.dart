...
library rest_xml.rest_xml_protocol.test.query_params_as_string_list_map_operation_test_test;
...
class _QueryParamsAsStringListMapInputRestXmlSerializer extends _i4
    .StructuredSmithySerializer<_i5.QueryParamsAsStringListMapInput> {
  const _QueryParamsAsStringListMapInputRestXmlSerializer()
