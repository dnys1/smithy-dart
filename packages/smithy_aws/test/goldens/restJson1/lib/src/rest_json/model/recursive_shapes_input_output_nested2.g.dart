...
part of rest_json1.rest_json.model.recursive_shapes_input_output_nested2;
...
class _$RecursiveShapesInputOutputNested2
  ...
  factory _$RecursiveShapesInputOutputNested2(
      ...
      (new RecursiveShapesInputOutputNested2Builder()..update(updates)).build();
...
class RecursiveShapesInputOutputNested2Builder
  ...
  @override
  _$RecursiveShapesInputOutputNested2 build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'RecursiveShapesInputOutputNested2', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
