...
class SmokeTestRequest private constructor(builder: Builder) {
    ...
    companion object {
        operator fun invoke(block: Builder.() -> kotlin.Unit): com.test.model.SmokeTestRequest = Builder().apply(block).build()
    }

    override fun toString(): kotlin.String = buildString {
        append("SmokeTestRequest(")
    ...
    inline fun copy(block: Builder.() -> kotlin.Unit = {}): com.test.model.SmokeTestRequest = Builder(this).apply(block).build()
    ...
    class Builder {
        ...
        @PublishedApi
        internal constructor(x: com.test.model.SmokeTestRequest) : this() {
        ...
        @PublishedApi
        internal fun build(): com.test.model.SmokeTestRequest = SmokeTestRequest(this)
