...
library rest_json1.rest_json_protocol.operation.malformed_timestamp_body_http_date_operation;
...
class MalformedTimestampBodyHttpDateOperation extends _i1.HttpOperation<
    ...
    _i1.Unit,
    _i1.Unit> {
  MalformedTimestampBodyHttpDateOperation({Uri? baseUri, required this.region})
      : _baseUri = baseUri;
