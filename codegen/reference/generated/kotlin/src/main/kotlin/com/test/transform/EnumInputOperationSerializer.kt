...
import com.test.model.EnumInputRequest
...
private fun serializeEnumInputOperationBody(context: ExecutionContext, input: EnumInputRequest): ByteArray {
    val serializer = JsonSerializer()
    val NESTEDWITHENUM_DESCRIPTOR = SdkFieldDescriptor(SerialKind.Struct, JsonSerialName("nestedWithEnum"))
    val OBJ_DESCRIPTOR = SdkObjectDescriptor.build {
        field(NESTEDWITHENUM_DESCRIPTOR)
    }

    serializer.serializeStruct(OBJ_DESCRIPTOR) {
        input.nestedWithEnum?.let { field(NESTEDWITHENUM_DESCRIPTOR, it, ::serializeNestedEnumDocument) }
    }
