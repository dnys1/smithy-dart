...
part of aws_json1_0.json_rpc10.model.complex_error;
...
class _$ComplexError extends ComplexError {
  ...
  _$ComplexError._({this.nested, this.topLevel}) : super._();
...
class ComplexErrorBuilder
  ...
  _$ComplexError build() {
    ...
    try {
      _$result = _$v ??
          new _$ComplexError._(nested: _nested?.build(), topLevel: topLevel);
    } catch (_) {
